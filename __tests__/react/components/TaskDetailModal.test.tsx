...
describe("TaskDetailModal", () => {
  ...
  it("renders task title when open", () => {
    render(<TaskDetailModal task={mockTask} open={true} onOpenChange={onOpenChange} />);
  ...
  it("does not render content when closed", () => {
    render(<TaskDetailModal task={mockTask} open={false} onOpenChange={onOpenChange} />);
  ...
  it("renders 'No description provided' when description is empty", () => {
    ...
    render(<TaskDetailModal task={taskNoDesc} open={true} onOpenChange={onOpenChange} />);
  ...
  it("calls delete mutation when delete button is clicked", () => {
    ...
    const buttons = screen.getAllByRole("button");
    const deleteBtn = buttons.find(btn => btn.textContent?.trim() !== "Close")!;
