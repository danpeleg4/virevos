    ...
    <main className="mx-auto max-w-4xl px-6 py-16 text-gray-800">
      ...
      <section className="space-y-8 leading-relaxed">
        <div>
          ...
          <p>
            Virevos is committed to protecting the personal data of EU residents
        ...
        <div>
          ...
          <p>
            ...
            interests, and user consent where required.
          </p>
        </div>
        ...
        <div>
          ...
          <p>
            Data may be transferred outside the EU to countries with adequate
            protection or under standard contractual clauses.
          </p>
        </div>
        ...
        <div>
          ...
          <p>
            To exercise your rights or raise concerns, contact our Data
