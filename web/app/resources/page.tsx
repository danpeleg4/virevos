...
const resources = [
  {
    ...
    title: "Documentation",
    description:
      "Comprehensive guides and API documentation to help you get the most out of Virevos.",
    link: "/docs",
    color: "blue",
  },
  {
    ...
    title: "Blog",
    description:
      "Tips, best practices, and insights on productivity and team collaboration.",
    link: "/blog",
    color: "purple",
  },
  {
  ...
  },
  {
    ...
    description:
      "Connect with other Virevos users, share tips, and get help from the community.",
    link: "/community",
    color: "orange",
  },
];
...
const articles = [
  {
    ...
    excerpt:
      "Learn proven strategies to help your team work more efficiently and accomplish more every day.",
    date: "Nov 5, 2025",
    readTime: "5 min read",
  },
  {
    ...
    excerpt:
      "A comprehensive guide to creating and automating workflows that match your team's unique process.",
    date: "Nov 2, 2025",
    readTime: "8 min read",
  },
  {
    ...
    excerpt:
      "Learn how a creative agency used Virevos to manage 3x more clients without adding headcount.",
    date: "Oct 28, 2025",
    readTime: "6 min read",
  },
  {
    ...
    excerpt:
      "Make the most of the Virevos-Slack integration with these expert tips and tricks.",
    date: "Oct 25, 2025",
    readTime: "4 min read",
  },
];
      ...
      >
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto">
            ...
            >
              Everything you need to master Virevos and boost your team&#39;s
              productivity
            </motion.p>
          </div>
        </div>
            ...
            {resources.map((resource, index) => (
              <motion.div key={index} variants={fadeInUp}>
                <Card className="p-8 h-full hover:shadow-xl transition-all duration-300 border-gray-200 group cursor-pointer">
                  <div
                    className={`rounded-lg w-14 h-14 flex items-center justify-center mb-6 ${colorClasses[resource.color as keyof typeof colorClasses]}`}
                  >
