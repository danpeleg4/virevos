  ...
  return [
    {
      ...
      content: "Hi team, I wanted to follow up on the timeline we discussed for the Q4 rollout. Can we schedule a quick call to review the milestones? I have a few questions about the API integration phase and want to make sure we're aligned on the approach. Looking forward to your thoughts.",
      timestamp: "Nov 11, 9:30 AM",
      date: new Date(baseDate.getTime() - 2 * 60 * 60 * 1000),
      starred: true,
      actionItems: ["Schedule Q4 timeline review call", "Review API integration approach"],
    },
    {
      id: "2",
      type: "chat",
      from: "You",
      to: "Sarah Johnson",
      content: "Absolutely! I'm available tomorrow afternoon or Thursday morning. Which works better for you? I'll prepare some documentation on the API integration approach so we can discuss it in detail.",
    ...
    },
    {
      ...
      from: "Sarah Johnson",
      to: "You",
      content: "Thursday morning works perfectly! Let's do 10 AM. Thanks for preparing the docs in advance - that will really help us make the most of our time.",
    ...
    },
    {
      ...
      content: "Great! I've scheduled our call for Thursday at 10 AM. I've also attached the API integration documentation and a proposed timeline for review. Please take a look before our call if you have time. Looking forward to discussing this with you!",
    ...
    },
    {
      ...
      content: "Quick question about the resource allocation for Q4. We're considering bringing in an additional backend developer for the integration phase. What's your take on this? Would it help accelerate the timeline or would onboarding slow things down?",
        ...
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-hidden flex flex-col">
          <DialogHeader>
            <div className="flex items-center space-x-4">
              ...
              <div>
                <DialogTitle className="text-xl">{clientName} - Conversation History</DialogTitle>
          ...
          <div className="space-y-4 flex-1 overflow-y-auto">
              ...
              <Card>
                <CardContent className="pt-4 pb-3">
                  <div className="text-center">
                    <p className="text-2xl text-gray-900">{filteredMessages.length}</p>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-2">
                      ...
                      <p className="text-sm text-blue-900">
                        <strong>{totalActionItems}</strong> action items identified from these conversations
                      </p>
                    </div>
            ...
            <div className="space-y-4">
              {filteredMessages.map((message, index) => (
                ...
                >
                  <Card className={message.starred ? "border-yellow-200 bg-yellow-50/30" : ""}>
                          ...
                          <div className="bg-green-50 border border-green-200 rounded-md p-2">
                            ...
                            <ul className="space-y-1">
                              {message.actionItems.map((item, idx) => (
                                <li key={idx} className="text-xs text-green-700 pl-4">
                                  • {item}
                                </li>
                              ))}
                            </ul>
