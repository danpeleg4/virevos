  ...
  return (
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <CardContent className="p-6 space-y-6">
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        <h3 className="text-lg font-semibold text-gray-900">{selectedMessage.from}</h3>
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <Button variant="outline" size="sm" onClick={() => setShowThreadDialog(true)}>
        ...
        <ScheduleMessageDialog
            ...
            onSchedule={(schedule) => {
              toast.success(`Message scheduled for ${schedule.date.toLocaleDateString()} at ${schedule.time}`);
            }}
        />
        {selectedMessage && (
          <MessageThreadDialog
